...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0 text-dark" id="headerSA">Selamat Datang Di Dashboard Super Admin</h1>
                </div>
                <!-- <div class="col-sm-6">
...
<script>
    $(document).ready(function() {
        ...
        setInterval(function() {
            headerSA.innerHTML = "Selamat Datang Di Dashboard Super Admin " + new Intl.DateTimeFormat('in', options).format(new Date);
        }, 1000);
    })
</script>