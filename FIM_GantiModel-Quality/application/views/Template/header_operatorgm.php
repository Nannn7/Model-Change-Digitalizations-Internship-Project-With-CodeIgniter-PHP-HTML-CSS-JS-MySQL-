        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link">Operator Ganti Model</a>
                </li>
            </ul>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?= site_url('Operator_Gantimodel'); ?>" class="nav-link <?= ($activePage == 'Operator_Gantimodel') ? 'active' : ''; ?>">
                        ...
                        <!-- <li class="nav-item">
                            <a href="<?= site_url('GM_Ongoing'); ?>" class="nav-link <?= ($activePage == 'GM_Ongoing') ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item">
                            <a href="<?= site_url('GM_Preview'); ?>" class="nav-link <?= ($activePage == 'GM_Preview') ? 'active' : ''; ?>">
                        ...
                        <li class="nav-item
                            <?= ($activePage == 'GM_CetakGM') ? 'menu-open' : ''; ?>
                            <?= ($activePage == 'GM_CetakDY') ? 'menu-open' : ''; ?>">

                            <a href="#" class="nav-link
                                <?= ($activePage == 'GM_CetakGM') ? 'active' : ''; ?>
                                <?= ($activePage == 'GM_CetakDY') ? 'active' : ''; ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= site_url('GM_CetakGM'); ?>" class="nav-link <?= ($activePage == 'GM_CetakGM') ? 'active' : ''; ?>">
                                        <i class="fas fa-tachometer-alt nav-icon"></i>
                                        <p>
                                            Cetak Ganti Model
                                        </p>
                                ...
                                <li class="nav-item">
                                    <a href="<?= site_url('GM_CetakDY'); ?>" class="nav-link <?= ($activePage == 'GM_CetakDY') ? 'active' : ''; ?>">
