...
class SA_Preview extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('Superadmin/preview', $data);
    }
    ...
    public function previewGM()
    {
        ...
        $this->load->view('Template/header_superadmin', $data);
        $this->load->view('Superadmin/previewGM', $data);
    }
    ...
    public function previewDY()
    {
        ...
        $this->load->view('Template/header_superadmin', $data);
        $this->load->view('Superadmin/previewDY', $data);
    }
}
