            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('Cetak_GM'); ?>" method="get">
                                <div class="row">
                                    <div class="col-2">
                                ...
                                if (isset($_GET['filter']))
                                    echo '<a href="' . base_url('Cetak_GM') . '" class="btn btn-default mb-3">Reset</a>';
                                ?>
                            </form>
                                    ...
                                    <?php foreach ($gmdata as $gm) { ?>
                                        <?php if (!empty($gm->finish_gm)) { ?>
                                            <tr>
                                                ...
                                                <td><?= $gm->start_gm; ?></td>
                                                <td>
                                                    <a href="<?= site_url('Cetak_GM/gantimodel/' . $gm->id_gm); ?>" class="btn btn-warning" title="Cetak Data GM" type="button">
