...
class Qty_Preview extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('OperatorQty/preview', $data);
    }
    ...
    public function previewGM()
    {
        ...
        $this->load->view('Template/header_operatorqty', $data);
        $this->load->view('OperatorQty/previewGM', $data);
    }
    ...
    public function previewDY()
    {
        ...
        $this->load->view('Template/header_operatorqty', $data);
        $this->load->view('OperatorQty/previewDY', $data);
    }
