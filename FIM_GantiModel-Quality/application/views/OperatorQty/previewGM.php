            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('Qty_Preview/previewGM'); ?>" method="get">
                                <div class="row">
                                    <div class="col-2">
                                ...
                                if (isset($_GET['filter']))
                                    echo '<a href="' . base_url('Qty_Preview/previewGM') . '" class="btn btn-default mb-3">Reset</a>';
                                ?>
                            </form>
...
<script>
    $(document).ready(function() {
        ...
        function showDetailModal(idGM) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= site_url('Qty_Preview/ListGMOnGoing'); ?>",
                data: {
                    idGM: idGM
                },
