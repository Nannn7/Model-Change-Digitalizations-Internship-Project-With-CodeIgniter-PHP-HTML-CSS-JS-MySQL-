            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= base_url('Qty_CetakGM'); ?>" method="get">
                                <div class="row">
                                    <div class="col-2">
                                ...
                                if (isset($_GET['filter']))
                                    echo '<a href="' . base_url('Qty_CetakGM') . '" class="btn btn-default mb-3">Reset</a>';
                                ?>
                            </form>
                                    ...
                                    <?php foreach ($gmdata as $gm) { ?>
                                        <?php if (!empty($gm->finish_gm)) { ?>
                                            <tr>
                                                ...
                                                <td><?= $gm->start_gm; ?></td>
                                                <td>
                                                    <a href="<?= site_url('Qty_CetakGM/gantimodel/' . $gm->id_gm); ?>" class="btn btn-warning" title="Cetak Data GM" type="button">
                                                        <i class="fas fa-file-pdf"></i>
                                                    </a>
                                                    <!-- <a href="<?= site_url('Qty_CetakGM/gantimodel/' . $gm->id_gm); ?>" class="btn btn-warning btn-download-pdf" title="Cetak Data GM" type="button" data-id="<?= $gm->id_gm ?>">
                                                        <i class="fas fa-file-pdf"></i>
                                                    </a> -->
                                                </td>
                                            </tr>
