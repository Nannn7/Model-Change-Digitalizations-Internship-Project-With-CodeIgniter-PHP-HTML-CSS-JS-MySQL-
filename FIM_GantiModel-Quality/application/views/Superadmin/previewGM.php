                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-header-back" title="Kembali Ke Halaman Sebelumnya">
                                <a href="<?= site_url('SA_Preview') ?>" class="btn btn-primary btn-sm"><i class="fas fa-arrow-circle-left"></i></a>
                            </div>
                            <h4>Data Measurement Preview Ganti Model</h4>
                        </div>
                        <div class="card-body">
                            <form action="<?= base_url('SA_Preview/previewGM'); ?>" method="get">
                                <div class="row">
                                    <div class="col-2">
                                ...
                                if (isset($_GET['filter']))
                                    echo '<a href="' . base_url('SA_Preview/previewGM') . '" class="btn btn-default mb-3">Reset</a>';
                                ?>
                            </form>
...
<script>
    $(document).ready(function() {
        ...
        function showDetailModal(idGM) {
            ...
            $.ajax({
                type: "POST",
                url: "<?= site_url('SA_Preview/ListGMOnGoing'); ?>",
                data: {
                    idGM: idGM
                },
