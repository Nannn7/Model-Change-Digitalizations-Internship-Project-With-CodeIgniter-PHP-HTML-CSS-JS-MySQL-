...
class Qty_CetakDY extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (empty($start_ukur) or empty($finish_ukur)) {
            ...
            $url_cetak = 'Qty_CetakDY/pdfcetak';
            $label = 'Semua Data Daily';
        } else {
            $daily = $this->model_ongoing->viewByDate($start_ukur, $finish_ukur);
            $url_cetak = 'Qty_CetakDY/pdfcetak?start_ukur=' . $start_ukur . '&finish_ukur=' . $finish_ukur;
        ...
        $this->load->view('OperatorQty/cetakDY', $data);
    }
    ...
    public function pdfcetak()
    {
        ...
        ob_start();
        $this->load->view('OperatorQty/pdfDY', $data);
